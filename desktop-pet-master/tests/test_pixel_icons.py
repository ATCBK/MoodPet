...
def test_recommended_feature_icon_names_are_stable():
    ...
    assert pixel_icon_name("sidebar_realtime") == "pixelarticons:camera"
    assert pixel_icon_name("sidebar_todo") == "pixelarticons:checklist"
    assert pixel_icon_name("sidebar_games") == "pixelarticons:gamepad"
    assert pixel_icon_name("sidebar_settings") == "pixelarticons:sliders"
